...
<html>
  <head>
    <title>UPDATE BUKU | Pemweb</title>
        ...
        <h1>Tes</h1>
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form">
              ...
              <input type="text" class="input_text" name="kategori_buku" id="kategori_buku" placeholder="Kategori..." value="<?= $data_update[5];?>" required>
            </div>

            <div class="form">
              <label for="halaman_buku">Jumlah Halaman Buku</label>
              <input type="text" class="input_text" name="halaman_buku" id="halaman_buku" placeholder="Halaman..." value="<?= $data_update[6];?>" required>
            </div>

            <div class="form">
              <label for="cover_buku">Cover Buku</label>
              <input type="hidden" name="old_cover" value="<?= $data_update[7];?>">
              <img src="<?= $data_update[7];?>" width="200" alt="gambar" class="cover_lama"/>
